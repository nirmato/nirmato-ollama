...
import org.nirmato.ollama.api.GenerateEmbeddingResponse
...
internal class EmbeddedClient internal constructor(private val requester: HttpRequester) : EmbeddingsApi {
    override suspend fun generateEmbedding(generateEmbeddingRequest: GenerateEmbeddingRequest): GenerateEmbeddingResponse {
